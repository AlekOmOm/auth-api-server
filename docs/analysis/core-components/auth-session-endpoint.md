...
```json
{
  ...
  "data": {
    ...
    "sessionId": "some-session-identifier-uuid",
    "allowedUrls": [
...
// Schema: auth_internal
{
  ...
  "data": {
    "isAuthenticated": true,
    "user": {
      "id": "owner-user-id-example",
      "name": "Auth System Owner",
      "email": "owner@authsystem.com",
      "role": "owner"
    },
    "schema": "auth_internal",
    "sessionId": "some-session-identifier-uuid-owner",
    "allowedUrls": []
  }
}
```
...
// Schema: client_trading_sim
{
  ...
  "data": {
    "isAuthenticated": true,
    "user": {
      "id": "client-user-id-example",
      "name": "Client App User",
      "email": "user@clientapp.com",
      "role": "user"
    },
    "schema": "client_trading_sim",
    "sessionId": "some-session-identifier-uuid-client",
    "allowedUrls": [
      "https://trading-sim.com",
      "https://trading-sim.com/app"
    ]
